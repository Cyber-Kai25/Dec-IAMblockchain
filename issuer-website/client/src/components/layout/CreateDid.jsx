        ...
        <div className="col-lg-10 col-xl-9">
          ...
          <div className="animate-fadeInUp mb-4 text-center">
            ...
            <h1 style={{ fontWeight: 800, fontSize: "2.2rem", letterSpacing: "-0.02em" }}>
              Manage Organization <span className="gradient-text">DID</span>
            </h1>
            <p style={{ color: "var(--text-secondary)", fontSize: "0.95rem", maxWidth: "600px", margin: "0 auto" }}>
              Generate, register, and inspect your organization's Decentralized Identifier (DID) to enable trustless credential signatures.
            </p>
          </div>
          ...
          <div className="auth-card animate-fadeInUp delay-2" style={{ padding: "32px" }}>
            {isLoading ? (
              <div className="text-center py-5">
                ...
                <PulseLoader size={12} color="var(--accent-cyan)" margin={6} />
              </div>
            ) : (
              <>
                {user.did ? (
                  <div>
                    ...
                    <div className="mt-4" style={{
                      ...
                      <strong style={{ color: "#ef4444" }}>⚠️ Security Notice:</strong> Keep your private key extremely secure. It represents your cryptographic signing authority. Anyone with access can issue valid credentials in your name.
                    </div>
                  </div>
                ) : (

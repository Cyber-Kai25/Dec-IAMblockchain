        ...
        <div className="row g-4 mb-5 animate-fadeInUp delay-1">
          ...
          <div className="col-md-4">
            <div className="auth-card h-100" style={{ padding: "24px" }}>
              ...
              <p style={{ color: "var(--text-secondary)", fontSize: "0.85rem", flexGrow: 1 }}>
                Define templates for verifiable credentials (e.g. Exam pass) specifying required claim attributes.
              </p>
          ...
          {hasDid && (
            <div className="col-md-4">
              <div className="auth-card h-100" style={{ padding: "24px", background: "linear-gradient(135deg, rgba(124,58,237,0.06), rgba(0,212,255,0.04))", borderColor: "rgba(124,58,237,0.2)" }}>
                <div className="d-flex justify-content-between align-items-start mb-3">
                  <div style={{ padding: "10px", borderRadius: "10px", background: "rgba(124,58,237,0.15)", color: "#a78bfa" }}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="badge-accent" style={{ fontSize: "0.65rem", padding: "2px 8px", background: "rgba(124,58,237,0.15)", color: "#a78bfa", border: "1px solid rgba(124,58,237,0.25)" }}>
                    Admin
                  </span>
                </div>
                <h3 style={{ fontSize: "1.2rem", fontWeight: 700, marginBottom: "8px" }}>Analytics</h3>
                <p style={{ color: "var(--text-secondary)", fontSize: "0.85rem", flexGrow: 1 }}>
                  View live system metrics, issuance breakdowns, and revoke student credentials with one click.
                </p>
                <Link to="/admin-dashboard" className="btn-ghost text-center mt-3" style={{ fontSize: "0.85rem", padding: "8px", textDecoration: "none", borderColor: "rgba(124,58,237,0.3)", color: "#a78bfa" }}>
                  Open Analytics
                </Link>
              </div>
            </div>
